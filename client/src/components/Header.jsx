...
function Header() {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: '300px', padding: "20px 0px 20px 0px ", backgroundColor: "var(--bg-300)" }}>
      ...
      <div>
        <button style={{ position: "relative", marginRight: "75px", fontSize: "2rem", borderRadius: "50%", backgroundColor: "var(--text-200)" }}><PersonFill onClick={() => setOpen(!open)} style={{ paddingBottom: "4px" }}></PersonFill></button>
        {
          open && (
            <div>
              <div id="dropdown" ></div>
